  ...
  },
  {
    ...
    opts = {
      ...
      image = {
        enabled = true,
        doc = {
          -- render images/diagrams found in markdown & latex documents
          inline = true, -- show inline (Ghostty supports the Kitty graphics protocol)
          float = true, -- floating-window fallback preview
          max_width = 100, -- display cap in columns (default 80)
          max_height = 60, -- display cap in rows (default 40)
          -- conceal the source text so the diagram replaces the code block
          -- (default only conceals math; add mermaid)
          conceal = function(lang, type)
            return type == 'math' or lang == 'mermaid'
          end,
        },
        convert = {
          -- render mermaid at a fixed higher scale than the terminal DPR
          -- so the resulting PNG has more pixels and displays larger
          mermaid = function()
  ...
  },
  {
    ...
    opts = {
      ...
      checkbox = {
        ...
        checked = {
          icon = '󰱒 ',
          highlight = 'RenderMarkdownCheckboxChecked',
          scope_highlight = nil,
        },
        custom = {
          todo = {
            raw = '[~]',
            rendered = '󰔨 ',
            highlight = 'RenderMarkdownCheckboxPending',
            scope_highlight = nil,
          },
        },
      },
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = function()
      require('nvim-treesitter').install({
        ...
        'javascript', 'json', 'lua', 'luadoc', 'make', 'markdown', 'markdown_inline',
        'python', 'query', 'rust', 'sql', 'ssh_config', 'svelte', 'toml', 'tsx', 'typescript',
        'vim', 'vimdoc', 'yaml', 'zig',
      }):wait(300000)
    end,
    config = function()
